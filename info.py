...
PICS = (environ.get('PICS', 'https://envs.sh/ifj.jpg https://envs.sh/b25.jpg https://envs.sh/b2G.jpg https://envs.sh/b2z.jpg https://envs.sh/b2K.jpg https://envs.sh/b23.jpg https://envs.sh/b2C.jpg https://envs.sh/if_.jpg https://envs.sh/ifA.jpg https://files.catbox.moe/jzz1os.jpg')).split()
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-4840392045')
...
# MongoDB information
DATA_DATABASE_URL = environ.get('DATA_DATABASE_URL', "mongodb+srv://sreeharipradeep38:Fxfkkqb1deS33vDA@cluster0.uei2df5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
if len(DATA_DATABASE_URL) == 0:
    logger.error('DATA_DATABASE_URL is missing, exiting now')
    exit()
FILES_DATABASE_URL = environ.get('FILES_DATABASE_URL', "mongodb+srv://sreeharipradeep38:Fxfkkqb1deS33vDA@cluster0.uei2df5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/+-mQfm_FEeHphOWE9')
